...
var _user$project$Type$SendResult = function (a) {
	return {ctor: 'SendResult', _0: a};
};
...
var _user$project$Helpers$message = function (x) {
	return A2(
		_elm_lang$core$Task$perform,
...
var _user$project$Helpers$validate = function (model) {
	return (!model.errorOnTarget) && ((!model.errorOnSum) && (!model.errorOnEmail));
};
var _user$project$Helpers$validateEmail = function (model) {
	return !_elm_lang$core$String$isEmpty(model.email);
};
var _user$project$Helpers$validateSum = function (model) {
	return (!_elm_lang$core$String$isEmpty(model.sum)) && (!_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$Result$toMaybe(
			_elm_lang$core$String$toFloat(model.sum)),
		_elm_lang$core$Maybe$Nothing));
};
var _user$project$Helpers$validateTarget = function (model) {
	return !_elm_lang$core$String$isEmpty(model.target);
};
...
var _user$project$Helpers$sendInvoice = function (model) {
	var body = _elm_lang$http$Http$multipartBody(
		{
			ctor: '::',
			_0: A2(_elm_lang$http$Http$stringPart, 'id', model.id),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$http$Http$stringPart, 'target', model.target),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$http$Http$stringPart, 'sum', model.sum),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$http$Http$stringPart, 'email', model.email),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$http$Http$stringPart, 'successUrl', model.successUrl),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return _elm_lang$core$Native_Utils.eq(
		...
		_user$project$Type$SendResult,
		A3(_elm_lang$http$Http$post, url, body, _user$project$Helpers$decodeResult)) : _elm_lang$core$Platform_Cmd$none;
};
			...
			case 'ChangeTarget':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{target: _p0._0}),
					_1: _user$project$Helpers$message(_user$project$Type$ValidateTarget)
				};
			case 'ChangeSum':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{sum: _p0._0}),
					_1: _user$project$Helpers$message(_user$project$Type$ValidateSum)
				};
			case 'ChangeEmail':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{email: _p0._0}),
					_1: _user$project$Helpers$message(_user$project$Type$ValidateEmail)
				};
			case 'ValidateTarget':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							errorOnTarget: !_user$project$Helpers$validateTarget(model)
						}),
					{ctor: '[]'});
			case 'ValidateSum':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							errorOnSum: !_user$project$Helpers$validateSum(model)
						}),
					{ctor: '[]'});
			case 'ValidateEmail':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							errorOnEmail: !_user$project$Helpers$validateEmail(model)
						}),
					{ctor: '[]'});
			case 'SendInit':
				return {
				...
				if (_p0._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								invoiceSent: _elm_lang$core$Maybe$Just(_p0._0._0)
							}),
						{ctor: '[]'});
				} else {
					return A2(
...
var _user$project$View_Adv$emailView = function (model) {
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('editor-label'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('editor-field'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'text-box', _1: true},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'input-validation-error', _1: model.errorOnEmail},
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('укажите email'),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Type$ChangeEmail),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_0: A2(
								_elm_lang$html$Html$span,
								{
									...
									_0: _elm_lang$html$Html_Attributes$classList(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'field-validation-valid', _1: !model.errorOnEmail},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'field-validation-invalid', _1: model.errorOnEmail},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'field-validation-error', _1: model.errorOnEmail},
													_1: {ctor: '[]'}
												}
											}
										}),
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('проверьте указанный email'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$for('Sum'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('сумма к оплате'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			_0: A2(
				...
				},
				{
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'input-validation-error', _1: model.errorOnSum},
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('укажите сумму к оплате'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$name('Sum'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.sum),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Type$ChangeSum),
												_1: {ctor: '[]'}
											}
										}
									}
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('руб.'),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$br,
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{
											...
											_0: _elm_lang$html$Html_Attributes$classList(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'field-validation-valid', _1: !model.errorOnSum},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'field-validation-invalid', _1: model.errorOnSum},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'field-validation-error', _1: model.errorOnSum},
															_1: {ctor: '[]'}
														}
													}
												}),
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('проверьте указанную сумму'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('назначение платежа'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'text-box-long', _1: true},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'input-validation-error', _1: model.errorOnTarget},
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('укажите назначение платежа'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$name('Title'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.target),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Type$ChangeTarget),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_0: A2(
								_elm_lang$html$Html$span,
								{
									...
									_0: _elm_lang$html$Html_Attributes$classList(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'field-validation-valid', _1: !model.errorOnTarget},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'field-validation-invalid', _1: model.errorOnTarget},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'field-validation-error', _1: model.errorOnTarget},
													_1: {ctor: '[]'}
												}
											}
										}),
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('укажите назначение платежа'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View_Adv$invoiceSentView = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('display-field'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$View_Adv$invoiceReadyView = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Type$SendInit),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				A2(
					_elm_lang$core$List$append,
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Отправить счёт на оплату по почте'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value('отправить'),
										_1: {ctor: '[]'}
									}
								}
							},
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value('отмена'),
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'onclick', 'window.history.back();'),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _user$project$SendInvoiceLetterForm$init = function (flags) {
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _user$project$Helpers$message(_user$project$Type$ValidateTarget),
				_1: {
					ctor: '::',
					_0: _user$project$Helpers$message(_user$project$Type$ValidateSum),
					_1: {
						ctor: '::',
						_0: _user$project$Helpers$message(_user$project$Type$ValidateEmail),
						_1: {ctor: '[]'}
					}
				}
			})
...
var _user$project$SendInvoiceLetterForm$main = _elm_lang$html$Html$programWithFlags(
									...
									return A2(
										...
										function (successUrl) {
											return A2(
												...
												A2(_elm_lang$core$Json_Decode$field, 'sum', _elm_lang$core$Json_Decode$string));
										},
										A2(_elm_lang$core$Json_Decode$field, 'successUrl', _elm_lang$core$Json_Decode$string));
								},
								A2(_elm_lang$core$Json_Decode$field, 'sendUrl', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'render', _elm_lang$core$Json_Decode$string));
				},
...
if (typeof _user$project$SendInvoiceLetterForm$main !== 'undefined') {
    _user$project$SendInvoiceLetterForm$main(Elm['SendInvoiceLetterForm'], 'SendInvoiceLetterForm', undefined);
}
